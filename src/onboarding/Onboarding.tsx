...
function Scene1() {
  return (
    <div className="w-full h-full px-6 pt-10 overflow-y-auto">
      {/* Анимация */}
      <div className="relative h-80 w-full bg-linear-to-br from-amber-50 to-orange-100 rounded-[28px] flex items-center justify-center mb-4 overflow-hidden shadow-sm border border-zinc-200">
        {/* Фоновые частицы */}
        {[...Array(20)].map((_, i) => (
          <motion.div
            key={i}
      ...
      {/* Таблетка с заголовком и подзаголовком */}
      <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-4 mb-4">
        ...
        <p className="text-sm text-zinc-500">Где бонусы становятся активом.</p>
      </div>

      {/* Текст вынесен и увеличен */}
      <p className="text-xl font-medium text-zinc-700 leading-relaxed px-2">
...
function Scene2() {
  return (
    <div className="w-full h-full px-6 pt-10 overflow-y-auto">
      {/* Анимация */}
      <div className="relative h-80 w-full bg-linear-to-br from-emerald-50 to-green-100 rounded-[28px] flex items-center justify-center mb-4 overflow-hidden shadow-sm border border-zinc-200">
        {/* QR-код */}
        <motion.div
          className="relative"
          animate={{
      ...
      <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-4 mb-4">
        ...
        <p className="text-sm text-zinc-500">Ваши повседневные траты превращаются в ценность.</p>
      </div>
...
function Scene3() {
  return (
    <div className="w-full h-full px-6 pt-10 overflow-y-auto">
      {/* Анимация */}
      <div className="relative h-80 w-full bg-linear-to-br from-slate-50 to-slate-100 rounded-[28px] flex items-center justify-center mb-4 overflow-hidden shadow-sm border border-zinc-200">
        {/* Свечной график */}
      ...
      <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-4 mb-4">
        ...
        <p className="text-sm text-zinc-500">Здесь бонусы работают по законам рынка.</p>
      </div>
...
function Scene4() {
  return (
    <div className="w-full h-full px-6 pt-10 overflow-y-auto">
      {/* Анимация */}
      <div className="relative h-80 w-full bg-linear-to-br from-violet-50 to-purple-100 rounded-[28px] flex items-center justify-center mb-4 overflow-hidden shadow-sm border border-zinc-200">
      ...
      <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-4 mb-4">
        ...
        <p className="text-sm text-zinc-500">Вы управляете своими бонусами — а не наоборот.</p>
      </div>
