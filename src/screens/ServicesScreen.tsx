...
export default function ServicesScreen({ onBack }: { onBack: () => void }) {
  return (
    <motion.div
      ...
      <div className="mx-auto max-w-md px-4 pt-4 pb-28">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <div className="text-xl font-semibold">Сервисы</div>
          </div>
        </div>

        {/* Контент */}
        <div className="bg-white rounded-2xl border border-zinc-200 p-6 shadow-sm text-center">
          <p className="text-zinc-500">Здесь будет контент сервисов</p>
        </div>
      </div>
    </motion.div>
  );
